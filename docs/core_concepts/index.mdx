...
<div className="grid grid-cols-2 gap-6 mb-4">
	...
	<DocCard
		...
		description="Understand how Windmill validates arguments for scripts, flows, and resources to ensure data integrity and catch errors early."
		href="/docs/core_concepts/argument_validation"
	/>
	<DocCard
